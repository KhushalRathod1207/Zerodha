...
function RightSection({ imageURL, productName, productDescription, tryDemo, learnMore, googlePlayURL, appStoreURL }) {
    return (
                    ...
                    <div className="d-flex gap-3">
                        {googlePlayURL && (
                            <a href={googlePlayURL}>
                                <img src="media/images/" alt="Google Play" height="40" />
                            </a>
                        )}
                        {appStoreURL && (
                            <a href={appStoreURL}>
